...
export const drawMarker = (color: string, text?: string) => {
    ...
    marker.setAttribute('style', "transform: translate(-50%, -50%) translate(283px, 301px) rotateX(0deg) rotateZ(0deg); display:flex; align-items: center; justify-content:center;")
    marker.setAttribute('class', "mapboxgl-marker mapboxgl-marker-anchor-center")
    marker.innerHTML = `<svg display="block" height="41px" width="27px" viewBox="0 0 27 41">
                <defs>
