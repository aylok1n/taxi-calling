import { crew, setActiveCrew } from "../redux/crewsSlice"
...
export const CrewCard = (crew: crew) => {
    const dispatch = useAppDispatch()
    return (
        <ListItemButton onClick={() => dispatch(setActiveCrew(crew.crew_id))} alignItems="center">
            <ListItemAvatar>
